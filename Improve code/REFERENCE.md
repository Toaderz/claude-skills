...
## Purpose
Use this skill when assessing whether modules should be deepened (merged/consolidated) to reduce shallow coupling and integration risk. It provides a classification framework for dependencies and a standard issue template for proposing architectural improvements.
